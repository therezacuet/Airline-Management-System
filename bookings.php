...
?>
      ...
      <legend style="color:#006A4E">My Bookings</legend>
      ...
      if(f_logged_in()===true){ 
        ...
        while($row=mysql_fetch_assoc($result))
        {
          ...
          { 
            ...
            echo 'Passenger Age: '.$row['p_sex'].'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.'<br>';
            echo 'Passenger Sex: '.$row['p_age'].'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.'<br>';
            ...
            echo '<button style="background:#006A4E" type="submit" value="cancel" name="cancel" class="btn btn-primary">Cancel Bookings</button>';
            echo '<br/><hr>';
            echo '</form>';
          } else {
            echo '<br/><hr>';
