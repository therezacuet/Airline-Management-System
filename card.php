...
?>
	...
	<div class="row">
		...
		<div class="col-lg-4">
			<div class="well bs-component" style="color:#006A4E;background:#EFEEE9">
				<?php
					if(f_logged_in()===true) {
                        $puname = $_GET['puname'];
						$puadd = $_GET['puadd'];
      ...
      header('refresh: 3, url=flogin.php');
    }
				?>
				<legend style="color:#006A4E">Payment Option</legend>
				 <h4 style="color:#006A4E">Please give your payment following number:</h4>
				 <h4 style="color:#006A4E">01930-822942</h4>
				<form class="form-horizontal" action="confirm.php" method="POST">
                 <div class="form-group">
	                    <div class="col-lg-12">
					<select class="form-control" name="flight_path" id="select">
					...
					<div class="form-group">
	                    <div class="col-lg-12">
	                      <input type="text" required class="form-control" maxlength="32" name="ammount" id="flight_no" placeholder="Enter Payed Ammount">
	                    </div>
	                </div>
	                <div class="form-group">
	                    <div class="col-lg-12">
	                      <input type="text" required maxlength="32" class="form-control" name="payment_num" id="payment_num" placeholder="Enter Bkash No">
	                      </div>
	                ...
	                <button style="background:#006A4E" type="submit" id="book_f" name="book_f" class="btn btn-primary">Pay</button></center>
				</form>
			</div>
		</div>
		<div class="col-lg-4">
